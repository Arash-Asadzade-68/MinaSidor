...
//authenticated route for post request
// export function postAuthApiRouteHandler(req, res) {
...
// common route without authentication for post requests
export function postApiRouteHandler(req, res) {
